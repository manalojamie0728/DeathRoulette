...
init python:
    ...
    #persistent.innocent = False # Persistent: Determines if Innocent Route is cleared.
    #persistent.guilty = False # Persistent: Determines if Guilty Route is cleared.
...
label ch03_august:
    ...
    call ch03_01_prologue1 from _call_ch03_01_prologue1
    call ch03_02_prologue2 from _call_ch03_02_prologue2
    #call ch03_03_extrareview # REMOVED; UNNECESSARY
    call ch03_04_decision1 from _call_ch03_04_decision1
    call ch03_05_aftermath from _call_ch03_05_aftermath
    call ch03_06_investigation1 from _call_ch03_06_investigation1
    call ch03_07_investigation2 from _call_ch03_07_investigation2
    call ch03_08_facts5 from _call_ch03_08_facts5
    call ch03_09_ministryvisit from _call_ch03_09_ministryvisit
    call ch03_10_facts6 from _call_ch03_10_facts6
    call ch03_11_ceasefire from _call_ch03_11_ceasefire
    if persistent.innocent and persistent.guilty:
        call ch03_12_death03 from _call_ch03_12_death03
        call ch03_13_epilogue from _call_ch03_13_epilogue
...
label ch03_01_prologue1:
    ...
    scene black with fade
    nvl clear
    narr "The infamous NSUEE (National State University Entrance Exam) has seen tens of thousands of students annually vying for a slot.{w=1.0} Sadly, never had there been a passing rate exceeding one-fifth. Virtually, even a hundred is impossible."
    narr "Nevertheless, it is left to the student's own mileage whether the privilege, should it be granted to them, is truly worth it.{w=1.0} What lies ahead is a journey that relies on wits, perseverance, and a good heart, not some stroke of luck."
    ...
    narr "The road was nearly empty, devoid of even the usual joggers and bikers on the inner half of the oval. Dubbed the \"Academic Oval\" by NSU denizens, most of the major colleges and institutions are placed around its arc."
    ...
    nvl clear
    narr "It took a good five minutes before I arrived at an answer.{w=1.0} I contemplated upon this question the most while eating the second sandwich. It was, I decided, the best question of the entire test by far."
    ...
    narr "Whatever. If my mind is derailed for even one second at this stage, everything will fall apart.{w=1.0} {cps=15}Just focus...{/cps}"

    nvl clear
    narr "I have nothing to say about this part. Nothing is certain here."
    narr "I have yet to gauge my performance from the reviewers provided to us. My confidence level is much lower than in the previous sections."
...
label ch03_02_prologue2:
    ...
    mh8 "I didn't mean to. I haven't said anything.{w=1.0} Inoue's a bright girl; she'll catch on eventually.{w} The thought unsettles me. There's no telling what will happen in the next few moments."
    ...
    play music bg_disturbedsoundscape loop
    ...
    f_mh8 "{b}*COUGH*{w=0.5} *COUGH*{w=0.5}{/b} That's right.{w=1.0} L.C. terrorized us here while you were away. Some of us even thought they were going after you next."
    show inoue noglass serious at Three2 with Dissolve(0.2)
    c_is4 "If not me, then who?{w=1.0} Who did he take?"
    ...
    r_is4 "{cps=15}May the Devil take the fool.{/cps}{w=1.0} Heh..."
    play sound sfx_giggle
    r_is4 "{cps=15}May the Devil take the fool.{/cps} Heh...{fast} Hehehehehehehehehehe..."
    ...
    call opening2 from _call_opening2
    return
...
label ch03_04_decision1:
    ...
    mh8 "She discovered the crime scene.{w=1.0} Inoue didn't exactly act friendly when I returned to the Council room. I'll let you fill in the details."
    show inoue sigh at Three2 with Dissolve(0.2)
    is4 "{b}{i}*groan*{/i}{/b}"
    show ichirou serious at Three1 with Dissolve(0.2)
    iy1 "We've crossed the boundary, it seems. Shouldn't we move on to whatever we came for?"
    hide miyu with Dissolve(0.2)
    ...
    show inoue noglass worried at Three2 with Dissolve(0.2)
    is4 "I inserted the CD and let it play while I examined the surroundings. A little after, I lied down on the bed, thinking about how I came to be there."
    ...
    menu:
        ...
        "Hold on. \"He?\"":
            ...
            show inoue noglass sad at Three2 with Dissolve(0.2)
            is4 "Hikaru, I found no such thing.{w=1.0} There was nothing on me except my glasses."
            hide hikaru with Dissolve(0.2)
        ...
        "Whose voices?":
            ...
            scene bg underwater nightmare with vpunch
    ...
    play sound sfx_creepylaugh
    unk "{i}Hah...{w=1.0} Hah...{w=1.0} Hahahaha...{w=1.0} Gyahahahahahahahahaha...{/i}{w=1.5}{nw}"

    play sound sfx_hiss
    "{i}*hissssssss*{/i}"

    is4 "The deed was done, and the door swung open by itself.{w=1.0} I did a quick search of the room.{w=1.0} Where was it? Where were they?{w=0.5} Never figured it out at the time."
    is4 "{cps=20}Point of no return... Point of no return...{/cps}"
    is4 "I entered the room, and two steps after, the door came crashing down on me!"
    ...
    scene bg blood2
    is4 "I thought I died!{w=1.0} My waist felt like the door split it cleanly into two.{w=1.0} {cps=20}Until I saw...{w=0.5} I was fine...{/cps}"
    iy1 "This is concerning.{w=0.5} It appears your mind has been playing tricks on you.{w=1.0} But to ask how and why wouldn't lead to anything at all!"
    ...
    is4 "Perhaps I was lucky to have survived. Maybe I didn't actually survive and you're all part of my imagination.{w=1.0} I don't know.{w=1.0}"
    is4 "I saw Kirisaki after that, but he was already a corpse by then. He was in the room where I almost got split into two!"
    ...
    mh8 "A zombie?! No way! {i}*chuckle*{/i} Too macabre for L.C.'s own caliber.{w=0.5} A spirit is more reasonable."
    ...
    mh8 "You swear?{w=1.0} Alright. Shed some light for us, then."
    hide miyu with Dissolve(0.2)
    show hikaru serious at Three1 with Dissolve(0.2)
    ...
    menu:
        ...
        "You saw Kirisaki dead? How?":
            ...
            mh8 "And a little while after is where the decontamination pools comes in?"
            is4 "Right.{w=0.5} I must have passed out twice during those times."
            hide miyu with Dissolve(0.2)
        ...
        "Maybe the corpse is a dummy?":
            ...
            play sound sfx_whoosh
            is4 "Whatever the case, he lunged at me, aiming at my heart.{w=1.0}{nw}"
            play sound sfx_glass
            is4 "Whatever the case, he lunged at me, aiming at my heart.{fast} I pushed him to the shelves, causing various chemicals to spill on his face.{w=1.0} He snapped out of it. It was peculiar..."
            st3 "Was there any acid among the spilled chemicals?"
            is4 "Presumably. The most significant one we found, though neither spilled nor acidic, was a small ampoule of liquid chlorine -- at least from the smell."
            ...
            show inoue noglass pissed at Three2 with Dissolve(0.2)
            is4 "I didn't have time to check. But it doesn't matter, anyway!"
    ...
    st3 "Unfortunately, this is where the story gets muddled up. Agreed?"
    show miyu proudclosed at Eight1 with Dissolve(0.2)
    mh8 "We are missing a few pieces in her story. Nevertheless, we have a few launchpads we can work with."
    ...
    ys6 "It should be somewhere close by.{w=1.0} You have to note, though, that no suspicious vehicles passed through the gate on the early morning of the 17th."
    show yoshiro serious at Eight8 with Dissolve(0.2)
    ys6 "Considering what activity we were busy with around that timeframe, the suspect must have used that to their advantage."
    show ichirou serious at Three3 with Dissolve(0.2)
    ...
    ys6 "It was used to bring the victims to that facility, most likely by vehicle. It's too suspect, but there is no other way."
    show miyu bored at Eight1 with Dissolve(0.2)
    mh8 "...Unless Inoue can remember."
    show inoue noglass serious2 at Three2 with Dissolve(0.2)
    is4 "I tell you. My memory remains hazy for that bit."
    hide inoue
    hide miyu
    hide sumiko
    hide yoshiro
    ...
    scene black
    unk "She doesn't have to.{w=1.0} We have asked the same question repeatedly to no positive end."
    is4 "{b}*GASP*{/b}"
    ...
    "She sat on the side closest to Miyu's group, facing away from the auditorium."
    ...
    iy1 "Good points.{fast} Let's return to the previous question.{w=1.0} Once more, who killed Kyou Kirisaki? Was it the same thing that attacked you?"
    ...
    iy1 "No, not that.{w=1.0} She's trying to cover it up."
    ...
    iy1 "There is that {i}one possibility{/i}. If it can't be proven, then we just press on. No big deal."
    hide akira with Dissolve(0.2)
    ...
    sr5 "Inoue, are you certain about your claim? Are you not needlessly incriminating yourself for Kirisaki's murder?"
    ...
    show inoue noglass angry at Three3 with Dissolve(0.2)
    is4 "After our fight in the conjuncting chemistry lab, a shelf full of chemicals crashed onto him. He was bathed with them and soon fell into a stupor."
    ...
    hy10 "{cps=25}Wipe your tears. We will seek justice for his death.{/cps}"
    show inoue noglass sadleft at Three2 with Dissolve(0.2)
    is4 "{cps=20}Yes...{w=0.5} I'm sure we will. {i}*sniffle*{/i}{/cps}"
    show yoshiro worriedleft at Three3 with Dissolve(0.2)
    ys6 "People may or may not believe what you said, to be frank.{w=2.0} Let me share my thoughts --{w=0.5} if they're worth considering."
    show inoue noglass talk at Three2 with Dissolve(0.2)
    is4 "Go on."
    show yoshiro talkleft at Three3 with Dissolve(0.2)
    ys6 "As Hikaru said, you're innocent. I concur.{w=1.0} You were both instruments, puppets who were forced to dance the way the true culprit had orchestrated."
    show yoshiro worried at Three3 with Dissolve(0.2)
    ys6 "At what extent your mind was warped, I cannot tell. But it dealt a considerable blow to your memory.{w=1.0} You may be aware of some of your actions, but bear in mind the questions you must answer to prove your innocence."
    show inoue noglass serious2 at Three2 with Dissolve(0.2)
    show hikaru serious at Three1 with Dissolve(0.2)
    hy10 "I understand where you're coming from, but why doubt her still? She told us her story and suppressed her fear in order to do so."
    show yoshiro talkleft at Three3 with Dissolve(0.2)
    ys6 "It's far more complicated than merely suppressing, Hikaru.{w=1.0} The only way we can relieve ourselves of doubt is to answer the most important question...{w=4.0}{nw}"
    ...
    hide miyu with Dissolve(0.2)
    hide sumiko with Dissolve(0.2)
    t_nat "Inoue and Sayo,{w=0.5} you two come with me.{w=1.0} We have to discuss the consequences of your actions. The rest of you I will be needing as witnesses."
...
label ch03_05_aftermath:
    if path_b1 < 0:
        call ch03_05A_guilty from _call_ch03_05A_guilty
    elif path_b1 >= 0:
        call ch03_05B_innocent from _call_ch03_05B_innocent
    return
...
label ch03_05A_guilty:
    ...
    show sayo blankface at Three1 with Dissolve(0.2)
    t_nat "Inoue, let me remind you that my patience with you is running thin.{w=1.0} You hurt other people during your outburst."
    ...
    ys6 "Exactly what I wanted to hear. Thank you."
    hide yoshiro with Dissolve(0.2)
...
label ch03_05B_innocent:
    ...
    narr "Miyu grimaced as he rubbed against the tiny bruises on his left arm and knee. He had hit the edge of the stone seat.{w} Sumiko was cleaning his glasses, checking it for any cracks."
    ...
    mh8 "I cannot stand watching people point fingers on a hunch. If we are to nab the killer, I suggest we do it ourselves.{w=1.0} We are the most affected, after all."
    show sayo serioustalkleft at Eight6 with Dissolve(0.2)
    sr5 "And also the persons of interest."
    mh8 "Which is another problem."

    show sayo normaltalk at Eight6 with Dissolve(0.1)
    show miyu talk at Three1 with Dissolve(0.1)
    stop music
    "{i}*snap*{/i}"
    ...
    while i1_office < 7 or i1_conference < 15:
        if current_area == 0: # Office
            if not parse_bin(visited,0):
                ...
                play music bg_disturbedsoundscape loop
                scene bg facultyroom night with fade
                        ...
                        "Sayo Ronoroa":
                            ...
                            while lock == 1  and (i1_office < 7 or i1_conference < 15):
                                menu:
                                    "Last seen alive":
                                        play sound sfx_beep2
                                        show portrait hiroshi at PortraitL with Dissolve(0.1)
                            ...
                            while lock == 1 and (i1_office < 7 or i1_conference < 15):
                                menu:
                                    ...
                                    "Power outage":
                                        ...
                                        show akira surprised at Three1 with Dissolve(0.2)
                                        play sound sfx_beep2
                                        show portrait sumiko at PortraitR with Dissolve(0.1)
                                        c_ai2 "Doing my business. I was with these three stooges:{w=1.0} Sumiko,{w=0.5}{nw}"
                                        play sound sfx_beep2
                                        show portrait miyu at PortraitR with Dissolve(0.1)
                                        c_ai2 "Doing my business. I was with these three stooges:{w=1.0} Sumiko,{fast} Miyu,{w=0.5}{nw}"
                                        play sound sfx_beep2
                                        show portrait ichirou at PortraitR with Dissolve(0.1)
                                        c_ai2 "Doing my business. I was with these three stooges:{w=1.0} Sumiko, Miyu,{fast} and Ichirou."
                                        play sound sfx_beep2
                                        hide portrait with Dissolve(0.1)
...
label ch03_07_investigation2:
    if path_b1 < 0:
        call ch03_07A_guilty from _call_ch03_07A_guilty
    elif path_b1 >= 0:
        call ch03_07B_innocent from _call_ch03_07B_innocent
    return
...
label ch03_07A_guilty:
    ...
    show yoshiro casual blankleft at Three2 with Dissolve(0.2)
    ...
    show yoshiro casual smile2 at Three2 with Dissolve(0.2)
    ys6 "Oh, you're finally here!{w=1.0} Just a moment. Akira is buying some bread."

    show akira casual smile at Three3 with Dissolve(0.2)
    "True enough, he approached us with a bag of pastries and is munching on a big ensaymada."

    iy1 "That's too much sugar in the morning. Plus, we aren't allowed to make a mess inside the library."
    show akira casual happy2 at Three3 with Dissolve(0.2)
    ai2 "I know, but this is my breakfast.{w=0.5} Woke up before nine. Ahehehehehe."
    iy1 "It's a miracle you arrived before me."
    show inoue casual talk at Three1 with Dissolve(0.2)
    is4 "So, where is the city library again?"
    show yoshiro casual smiletalk at Three2 with Dissolve(0.2)
    ys6 "At the park near my girlfriend's house.{w=1.0} I will lead the way."
    show inoue casual smile2 at Three1 with Dissolve(0.2)
    show akira casual proud at Three3 with Dissolve(0.2)
    ai2 "Cool! Let's go."
    hide akira with Dissolve(0.1)
    ...
    stop sound fadeout 2.0
    "He's already on his second pastry.{w=1.0} The pig!"
    ...
    show akira casual smileleft at Three1 with Dissolve(0.2)
    ...
    show yoshiro casual serioustalk at Three2 with Dissolve(0.2)
    ...
    scene black with fade
    centered "{color=#bd0000}--INVESTIGATION START--{/color}"
    play music bg_mellowpuzzler loop
        ...
        if current_area == 0: # Circulation
            ...
            menu:
                    ...
                    menu:
                        "Information Desk":
                            ...
                            while lock == 1 and (i2a_genreference not in [24, 25, 26, 28, 29, 30, 31] or i2a_periodicals not in [187, 191, 251, 255]):
                                if not (parse_bin(i2a_circulation,0) or parse_bin(i2a_circulation,1)):
                                ...
                                menu:
                                    "Operating hours":
                                        iy1 "What is your operating hours?{w=1.0} We might need to drop by here at night -- not today, of course."
                                    ...
                                    "Archives section":
                                        ...
                                        play music bg_mellowpuzzler loop
                                        show inoue casual serioustalk2 at Three3 with Dissolve(0.2)
                                        is4 "Why did you let him run off like that?!"
                                        show yoshiro casual smile at Three2 with Dissolve(0.2)
                                        ys6 "He knows what he's doing.{w=1.0} Besides, we can always text him if we ever find anything."
                                        hide yoshiro with Dissolve(0.2)
                                        hide inoue with Dissolve(0.2)
                                    ...
                                    "L.C. initials" if parse_bin(i2a_periodicals,0):
                                        if not parse_bin(i2a_circulation,2):
                                            ...
                                            "With that dexterity, she could have been a secretary or clerk in the past. Maybe she {i}is{/i} the clerk here?"

                                            librarian "Do you have a pen and paper? I'll list the names here."
                                            iy1 "Oh. I, uh...{w=1.0}{nw}"
                                            ai2 "Here."
                                            stop music
                                            show akira casual proud at Three1 with vpunch
                                            iy1 "Eh? Where did you come from?"
                                            show akira casual proud2 at Three1 with Dissolve(0.2)
                                            ai2 "I saw you coming down here so I followed. Figured you might need some pen and paper."
                                            iy1 "That's very resourceful of you."
                                            show akira casual proudclosed at Three1 with Dissolve(0.2)
                                            librarian "Here you go, sir."

                                            play sound sfx_pageturn
                                            "The list contains ten names with pertinent information -- age, status, and whatnot. Three of them are marked with {i}dec.{/i}"
                                            ...
                                            show akira casual happy2 at Three1 with Dissolve(0.2)
                                            ai2 "Lead the way, Ichi. I think you need more hands upstairs."
                                            iy1 "Okay. Let's go."
                                            hide akira with Dissolve(0.2)

                                            $ lock = 0
                                            play music bg_mindbender loop
                                            scene bg library periodicals with fade
                                            $ current_area = 2

                                            show akira casual happy2 at Three3 with Dissolve(0.2)
                                            ai2 "We got the goods."
                                            show yoshiro casual smile2 at Three1 with Dissolve(0.2)
                                            ys6 "Hey! You're here.{w=1.0} How did your research go?"
                                            show akira casual smile at Three3 with Dissolve(0.2)
                                            ai2 "I didn't find anything related to the case.{w=2.0} Still, I found a few interesting concepts that we may use to help with our investigation."
                                            show yoshiro casual smiletalk at Three1 with Dissolve(0.2)
                                            ys6 "I see. You're gonna stay here and help?"
                                            show akira casual surprised2 at Three3 with Dissolve(0.2)
                                            ...
                                            show akira casual bored at Three2 with Dissolve(0.2)
                                    ...
                                    "Children's section" if parse_bin(i2a_periodicals,5):
                                        if not parse_bin(i2a_circulation,3):
                                            ...
                                            play music bg_mindbender loop
                                            scene bg library periodicals with fade
                                            show inoue casual smile2 at Three3 with Dissolve(0.2)
                                            "Inoue was waiting for me outside the Periodicals section."
                                            
                                            show inoue casual determined at Three3 with Dissolve(0.2)
                                            ...
                                            show inoue casual smile at Three3 with Dissolve(0.2)
                                            play sound sfx_pageturn
                                            ...
                                            show yoshiro casual surprised at Three1 with Dissolve(0.2)
                                            ...
                                            play sound sfx_heartbeat loop
                                            show akira casual worriedtalkleft at Three1 with Dissolve(0.2)
                                            ai2 "Is this...{w=1.5}{nw}"
                                            show inoue casual creepy worriedleft at Three3 with Dissolve(0.5)
                                            is4 "{cps=20}A'tishoo! {i}{b}*hiss*{/b}{/i}{w=1.0} A'tishoo! {i}{b}*hiss*{/b}{/i}{w=1.5} We all...{w=0.5} fall{w=0.5} down...{w=0.5}{/cps}"
                                            show inoue casual creepy smirk at Three3 with Dissolve(0.2)
                                            play sound sfx_giggle
                                            is4 "{cps=20}Hehehehehehehe... Hehehehehehehehe...{/cps}"
                                            hide akira
                                            show yoshiro casual panic at Three2 with hpunch
                                            ys6 "Hey! Snap out of it!"
                                            stop sound
                                            show inoue casual sigh2 at Three3 with Dissolve(1.0)
                                            is4 "{i}*suck*{/i}{w=0.5} Hpf!{w=0.5} {b}*COUGH* *COUGH*{/b}{w=1.0} {i}*INHALE*{/i}"
                                            hide inoue with Dissolve(0.2)
                                            hide yoshiro with Dissolve(0.2)

                                            "We were lucky she didn't explode like she did a few days ago.{w=1.0} Blood returned to her lips."
                                            "Yoshiro and I assisted her to a chair and allowed her to breathe."

                                            show akira casual annoyed at Three2 with Dissolve(0.2)
                                            ai2 "{cps=30}So, this was the song meant for Kyou...{w=1.0} How morbid and sick a mind L.C. has.{/cps}"
                                            hide akira with Dissolve(0.2)
                                            ...
                                            "I already have the book...{w=1.5} and I already upset a grown woman with it.{w=1.0} Achievement unlocked!"
                ...
                "Talk":
                    menu:
                        "Yoshiro Suzuki":
                            show yoshiro casual serious at Three2 with Dissolve(0.2)
                            $ lock = 1
                            ...
                            while lock == 1 and (i2a_genreference not in [24, 25, 26, 28, 29, 30, 31] or i2a_periodicals not in [187, 191, 251, 255]):
                                menu:
                                    "What to look for?":
                                        ...
                                        show yoshiro casual serioustalk at Three2 with Dissolve(0.2)
                                        ys6 "Right. We can start by looking at some records related to both Kutsutochi and Sacred Heart Village.{w=1.0} We may also find some publications involving the person if necessary."
                                        iy1 "Is that all?"
                                        show yoshiro casual worried at Three2 with Dissolve(0.2)
                                        ys6 "I might have missed something, but that's all for now.{w=1.0} There is a wealthy amount of books and papers to check in this library, so let's take the time to read them while we are here."
                                        iy1 "Copy."
                                    ...
                                    "Night of the murder":
                                        stop music fadeout 1.0
                                        show yoshiro casual talk at Three2 with Dissolve(0.2)
                                        ...
                                        show yoshiro casual serioustalk2 at Three2 with Dissolve(0.2)
                                    ...
                                    "Science Club presidency":
                                        ...
                                        show yoshiro casual worried at Three2 with Dissolve(0.2)
                                        ys6 "If this is about the succession of the previous Sci Club presidency, forget it."
                                        ...
                                        play sound sfx_beep2
                                        show portrait odome at PortraitL with Dissolve(0.1)
            ...
            if not parse_bin(visited,1):
                ...
                show akira casual bored at Three3 with Dissolve(0.2)
                ...
                show akira casual smirk at Three3 with Dissolve(0.2)
                ...
                show akira casual proud at Three3 with Dissolve(0.2)
                ai2 "Text me if you find anything. I'll be sticking around for a while so we can get more info.{w=1.0} I won't mind if you want to strike up a good ol' chat."
                hide akira with Dissolve(0.2)
            ...
            menu:
                "Examine":
                    menu:
                        "Bookshelves":
                            ...
                            while lock == 1 and (i2a_genreference not in [24, 25, 26, 28, 29, 30, 31] or i2a_periodicals not in [187, 191, 251, 255]):
                                if not (parse_bin(i2a_genreference,0) or parse_bin(i2a_genreference,1) or parse_bin(i2a_genreference,2)):
                                    window show
                                    nvl clear
                                ...
                                menu:
                                    "Biochemistry":
                                        ...
                                        scene bg chlorine with dissolve
                                        narr "Uhhhhhhh... No. I'll leave this to Akira... He can grasp this better than me."
                                    ...
                                    "Criminal Psychology":
                                        ...
                                        scene bg casefile with dissolve
                                        window show
                                        nvl clear
                                        ...
                                        show sayo creepy serious at Eight8 with Dissolve(0.5)
                                        narr "{cps=10}Sayo?{/cps}{w=1.5}{nw}"
                                        show miyu naughty smile at Eight1 with Dissolve(0.5)
                                        narr "{cps=10}Miyu?{/cps}{w=1.5}{nw}"
                                        show inoue casual creepy smirk at Eight6 with Dissolve(0.5)
                                        narr "{cps=10}Inoue?{/cps}{w=1.5}{nw}"
                                        show hikaru casual worried at Eight3 with Dissolve(0.5)
                                        narr "{cps=10}Hikaru?{/cps}{w=1.5}{nw}"
                                        show ichirou casual smileleft at Three2 with Dissolve(0.5)
                                        narr "{cps=10}...Me?{/cps}{w=1.5}{nw}"
                                        show ichirou casual smile at Three2 with Dissolve(0.5)
                                        hide sayo with Dissolve(0.1)
                                        hide miyu with Dissolve(0.1)
                                        hide inoue with Dissolve(0.1)
                                        hide hikaru with Dissolve(0.1)
                                        show ichirou casual smirk at Three2 with Dissolve(0.5)
                ...
                "Talk":
                    menu:
                        "Akira Ichibana":
                            show akira casual smile at Three2 with Dissolve(0.2)
                            $ lock = 1
                            ...
                            while lock == 1 and (i2a_genreference not in [24, 25, 26, 28, 29, 30, 31] or i2a_periodicals not in [187, 191, 251, 255]):
                                menu:
                                    "Sorry for prank":
                                        ...
                                        show akira casual smirk at Three2 with Dissolve(0.2)
                                        ai2 "Ahahahahaha... I'm sorry, too."
                                        show akira casual boredtalk at Three2 with Dissolve(0.2)
                                        ...
                                        stop music
                                        show akira casual surprised at Three2 with Dissolve(0.2)
                                        ...
                                        show akira casual worriedtalk at Three2 with Dissolve(0.2)
                                        ai2 "I was screaming to you guys for help. That's why I was banging the stall door open."
                                        iy1 "We didn't hear you.{w=0.5} At all."

                                        centered "{cps=20}Weird.{w=1.0} I heard upperclassmen tell ghost stories concerning the restrooms before.{w=1.5} The girls' restroom had Samantha. What about the boys' restroom?{w=2.0}\nA portal to another dimension once you lock yourself inside the stall?{/cps}"

                                        play music bg_roadtohell loop
                                        show akira casual worriedleft at Three2 with Dissolve(0.2)
                                        ...
                                        show akira casual worried at Three2 with Dissolve(0.2)
                                    ...
                                    "Voices inside your head" if parse_bin(i2a_genreference,3):
                                        ...
                                        show akira casual worried at Three2 with Dissolve(0.2)
                                        ai2 "Something like that.{w=1.0} I thought one of you guys was on the other side."
                                        show akira casual worriedtalkleft at Three2 with Dissolve(0.2)
                                        ...
                                        ai2 "{cps=25}After a series of laughs, they counted.{/cps}{w=1.5} {i}{cps=10}One...{w=1.0} Two...{w=1.0} Three...{w=1.0}{/cps}{/i} {cps=25}And then, {i}bang!{/i}{w=0.5} They were forcing the door open. They were breaking it down!{/cps}"
                                        iy1 "Who were {i}they{/i}?{w=3.0}{nw}"
                                        show akira casual worriedtalk at Three2 with Dissolve(0.2)
                                        ...
                                        show akira casual sigh at Three2 with Dissolve(0.2)
                                        ...
                                        show akira casual serious at Three2 with Dissolve(0.2)
            ...
            menu:
                                ...
                                menu:
                                    "Research" if not parse_bin(i2a_circulation,2):
                                        if not parse_bin(i2a_periodicals,0):
                                            scene bg newspaper with dissolve
                                            play sound sfx_pageturn
                                            "The newspapers were dated as early as 1996, the year when Kutsutochi was established as a Capital Region city.{w} Earlier than that, it was part of the same province as Sacred Heart Village."
                                            play sound sfx_pageturn
                                            ...
                                            iy1 "Ugggggghhh... This is going nowhere real quick.{w=1.0} Thirty minutes have passed without any useful info."
                                            show inoue casual surprised at Three3 with Dissolve(0.2)
                                            is4 "Are you browsing the {i}correct{/i} articles?{w=1.0} Maybe you're cherry-picking what to read, Ichirou?"
                                            iy1 "I'm serious. Without so much as a reference point, we'll reach closing time not moving a step forward."
                                            show inoue casual talk at Three3 with Dissolve(0.2)
                                            ...
                                            "Just as I was about to grab another newspaper{nw}"
                                            play sound sfx_smack
                                            show inoue casual serious2 at Three3 with hpunch
                                            "Just as I was about to grab another newspaper,{fast} Inoue swiped the print before I could reach it."
                                            ...
                                            show inoue casual sigh at Three3 with Dissolve(0.2)
                                            is4 "Do it again and I'll aim for your cheeks next, you hear?"
                                            iy1 "{cps=20}I hear you.{/cps}"
                                            hide inoue with Dissolve(0.2)
                                    ...
                                    "Obituaries" if parse_bin(i2a_circulation,2):
                                        ...
                                        show akira casual proudclosed at Three2 with Dissolve(0.2)
                                        ...
                                        "Inoue is holding a dusted photograph covered in plastic.{w=1.0} I have seen its subject {i}recently{/i}."
                            ...
                            while lock == 1 and (i2a_genreference not in [24, 25, 26, 28, 29, 30, 31] or i2a_periodicals not in [187, 191, 251, 255]):
                                menu:
                                    ...
                                    "Missing child" if parse_bin(i2a_periodicals,1):
                                        ...
                                        "It was actually a poster, with only the subject visible at first. There are some text printed above below it."
                                        "In fact, the name is familiar."
                                        ...
                                        iy1 "They're dead, Inoue. Show some respect -- to her, at least."
                ...
                "Talk":
                    menu:
                        "Inoue Shinozaki":
                            if not parse_bin(i2a_circulation,3): # SMILING
                                show inoue casual smile2 at Three2 with Dissolve(0.2)
                            else: # DISTRESSED
                                show inoue casual sighclosed at Three2 with Dissolve(0.2)
                            $ lock = 1
                                ...
                                menu:
                                    "Nursery rhymes":
                                        if not parse_bin(i2a_circulation,3):
                                            ...
                                            show inoue casual serious at Three2 with Dissolve(0.2)
                                            is4 "I'll never forget that."
                                            iy1 "Then you must also know what rhyme played while he was being immolated, too."
                                            show inoue casual confusedtalk at Three2 with Dissolve(0.2)
                                            ...
                                            is4 "Sorry, Ichi. I don't know.{w=1.0} However, if you can hum the tune or show me the lyrics, you might be able to jog my memory."
                                            ...
                                            show inoue casual talk at Three2 with Dissolve(0.2)
                                            ...
                                            show inoue casual determined at Three2 with Dissolve(0.2)
                                            is4 "Of course!"

                                            play music bg_mindbender loop
                                            "Someone here agrees with me even without a name drop.{w=2.0}{nw}"

                                            show inoue casual schemingopen at Three2 with Dissolve(0.2)
                                            is4 "Though, I'll kill you first before you think of killing me, buster!"
                                            iy1 "Whoa! That's too far over the line!{w=1.0} Easy... {i}*chuckle*{/i}"

                                        else:
                                            show inoue casual sigh2 at Three2 with Dissolve(0.2)
                                            play sound sfx_breathing
                                            is4 "{i}*EXHALE*{/i}"
                                            iy1 "Are you sure you don't need medical assistance?"
                                            stop sound fadeout 1.0
                                            show inoue casual troubled at Three2 with Dissolve(0.2)
                                            is4 "No need.{w=2.0} Give me some breathing space, will you?{w=1.0} If you have nothing new or important to tell me, please save it for another day."

                                            "We already know what nursery rhyme triggered her unpleasant memories. It is unadvisable to show it for a second time, else she chew my head off."
                                    ...
                                    "Au Clair De La Lune" if parse_bin(bonus_b1_g,0):
                                        ...
                                        play music bg_auclairdelalune loop
                                        ...
                                        show inoue casual seriouspose at Three2 with Dissolve(0.2)
                                        ...
                                        iy1 "Remind me to keep a mouth zipper ready in case I get tempted to indulge in some dark secrets."
                                    ...
                                    "Let Carnegie" if parse_bin(i2a_periodicals,4):
                                        ...
                                        iy1 "Mhm?"
                                        play music bg_ghoststory loop
                                        show inoue casual serious2 at Three2 with Dissolve(0.2)
                                        play sound sfx_beep2
                                        show portrait let at PortraitR with Dissolve(0.1)
                                        is4 "Tell me more about the hit-and-run.{w=1.0} This Let Carnegie, what about her?"
                                        iy1 "That's all I can tell you. If you want more, let me fetch the article for you."
                                        play sound sfx_beep2
                                        hide portrait with Dissolve(0.1)
                                        ...
                                        "Really?{w} I thought there's another side to the story --{w=2.0} that Ms. Volante's payment is actually hush money?"
                                        ...
                                        show inoue casual confused at Three2 with Dissolve(0.2)
                                        ...
                                        show inoue casual serioustalk at Three2 with Dissolve(0.2)
                                        is4 "Exactly.{w=1.0} Why that overwhelming trust to someone you barely know?"
                                        iy1 "Anything else?"
                                        show inoue casual serious2 at Three2 with Dissolve(0.2)
                                        is4 "I didn't bother asking any more. Took it as a {i}slip of the tongue{/i}."

                                        stop music fadeout 1.0
                                        play music bg_onthingstocome loop
                                        "Understandable.{w} Although the nurse was being nice, that doesn't entitle her to spill secrets about her friend's personal life. It's a mark of a traitor."

                                        if not parse_bin(i2a_periodicals,7):
                                            $ i2a_periodicals += 128

                                    "Let's discuss more of this later. I need to do something else.":
                                        hide inoue with Dissolve(0.2)
                                        $ lock = 0
    ...
    narr "Much to my embarrassment, I exchanged the Mother Goose Rhymes for my ID.{w=1.0} This will be one hell of a story at dinnertime."

    nvl clear
    window hide

    play music bg_thecomplex loop
    show akira casual serious at Three1 with Dissolve(0.2)
    ai2 "From what we gathered, it seems L.C. is not from Kutsutochi.{w=1.0} {cps=30}At least, not in the way we think.{/cps}"
    show yoshiro casual serioustalk2 at Three2 with Dissolve(0.2)
    ys6 "That's true.{w=1.0} The closest lead we have is the sisters of young Let Carnegie."
    ys6 "But who are they?{w=1.0} The papers never even mentioned their names."
    show akira casual boredtalk at Three1 with Dissolve(0.2)
    ai2 "Still...{w=1.0} there is a possibility..."
    show yoshiro casual serious at Three2 with Dissolve(0.2)
    iy1 "..."
    show akira casual surprised2 at Three1 with Dissolve(0.2)
    ai2 "...of L.C. orchestrating the crimes outside Kutsutochi.{w=1.0} Come on, guys! You thought I would mention a deceased child somehow rising from the dead and starting the cursed killings for no good reason?"
    ...
    show inoue casual talk at Three3 with Dissolve(0.2)
    is4 "It's a shame we aren't allowed to take snapshots. Ichirou and I found some photographs worth referencing later on."
    show yoshiro casual smirk at Three2 with Dissolve(0.2)
    ys6 "Like the ones showcasing the younger versions of our advisers? {i}*chuckle*{/i}{w=1.0} Might be a handy tactic to get on their good side later on."
    ...
    show akira casual worried at Three1
    show yoshiro casual worried at Three2
    show inoue casual blank at Three3
    "{i}*GROWL*{/i}"
    stop sound fadeout 2.0

    play music bg_merrygo loop
    show akira casual fangblush at Three1 with Dissolve(0.2)
    ai2 "Uggggghhh... The three pieces of bread have done their job. They're screaming for a replacement!"
    ...
    hide akira with Dissolve(0.2)
    iy1 "Until now?!"
    show yoshiro casual surprised2 at Three2
    show inoue casual determined at Three3
    play sound sfx_sssh
    librarian "Shhhhhhhh!"
    show yoshiro casual serioustalk2 at Three2 with Dissolve(0.2)
    ys6 "Pardon us, ma'am."
...
label ch03_07B_innocent:
    ...
    show hikaru casual happy at Three1 with Dissolve(0.2)
    hy10 "Wow! I haven't been in places like this. Sadly, it doesn't look like anything what Hollywood shows."
    mh8 "Seriously? This isn't LAPD. {i}*chuckles*{/i}{w=1.0} And this also houses a police academy. Who would want prestige over function, anyway?"
    show hikaru casual happyleft at Three1 with Dissolve(0.2)
    hy10 "Yeah, but point is, this interior looks aesthetic."
    show sayo casual glass serioustalk at Three2 with Dissolve(0.2)
    ...
    hide hikaru with Dissolve(0.2)
    show sumiko casual surprisedtalk at Three1 with Dissolve(0.2)
    ...
    while not parse_bin(i2b_archives,2):
        if current_area == 0: # Reception Area
                    ...
                    menu:
                        "Reception Desk":
                            ...
                            while lock == 1 and not (parse_bin(i2b_archives,2)):
                                ...
                                menu:
                                    "Inspector Emmerich":
                                        show sayo casual glass normaltalk at Three2 with Dissolve(0.2)
                                        play sound sfx_beep2
                                        show portrait emmerich at PortraitL with Dissolve(0.1)
                                        sr5 "We are here on an appointment."
                                        officer "You know, I seem to recognize your voice, ma'am. Did you call here last month?"
                                        show sayo casual glass smiletalk at Three2 with Dissolve(0.2)
                                        ...
                                        show sayo casual normaltalkleft at Three2 with Dissolve(0.2)
                    ...
                    menu:
                        "Sayo Ronoroa":
                            ...
                            while lock == 1 and not (parse_bin(i2b_archives,2)):
                                menu:
                                    "What to look for?":
                                        show sumiko casual surprised at Three1 with Dissolve(0.2)
                                        ...
                                        show sayo casual glass serious at Three2 with Dissolve(0.2)
                                        ...
                                        show sayo casual glass sleepytalk at Three2 with Dissolve(0.2)
                                        ...
                                        show sayo casual glass seriousleft at Three2 with Dissolve(0.2)
                                        sr5 "We are expecting notes.{w=1.0} Heaps of notes, if we have that much time."
                                        show sumiko casual surprisedtalk at Three1 with Dissolve(0.2)
                                    ...
                                    "L.C.'s challenge":
                                        ...
                                        play sound sfx_beep2
                                        show portrait ayumi at PortraitL with Dissolve(0.1)
                                        mh8 "Say you didn't win the SC Presidency. Would Ayumi be L.C.'s primary target instead?"
                                        show sayo casual glass serioustalk at Three2 with Dissolve(0.2)
                                        sr5 "No."
                                        mh8 "Why so?"
                                        show sayo casual glass serioustalkleft at Three2 with Dissolve(0.2)
                                        ...
                                        show sayo casual glass serious at Three2 with Dissolve(0.2)
                                        sr5 "If anything, I am sure my position is trivial to the motive. It would take months of planning to pull them off successfully."
                                        show sayo casual glass smile at Three2 with Dissolve(0.2)
                                        ...
                                        mh8 "Sorry."
                                        show sayo casual glass serioustalkleft at Three2 with Dissolve(0.2)
                                        sr5 "It's what L.C. wants us to think.{w=1.0} They even pinned their identity on me by circumstance.{w=1.0} What do I know about fickle-minded freaks? You don't get to see those everyday."
                                    ...
                                    "Inoue's memories" if parse_bin(bonus_b1_i,1):
                                        ...
                                        show sayo casual glass seriousleft at Three2 with Dissolve(0.2)
                                        sr5 "For what? They'll gain nothing from harassing me.{w=1.0} Keep in mind, even I doubt Inoue's credibility despite the harrowing ordeal she experienced."
                                        stop music fadeout 1.0
                                        mh8 "Is it because of the supernatural details? We can explain them."
                                        show sayo casual glass normaltalk at Three2 with Dissolve(0.2)
                                        sr5 "You arrived before me, Mi-kun.{w=1.0} Come on. Use that \"particular set of skills\" of yours."

                                        centered "{cps=25}There are two major changes to Inoue's demeanor during that time.{w=3.0}\nThe first is when I, Sumiko, and Akira arrived.{w=2.0}\nThe second -- more significant than the first -- is when Sayo popped up out of nowhere.{/cps}"
                                        ...
                                        show sayo casual glass normaltalkleft at Three2 with Dissolve(0.2)
                                        sr5 "I can't say it's the same theory I have with L.C.'s voice during the mock exams. Keep in mind that {i}we never heard L.C. speak outside of that{/i}."
                                        ...
                                        show sayo smileopenpose at Three3 with Dissolve(0.2)
                                        ...
                                        show sayo casual glass smileclosed at Three2 with Dissolve(0.2)
                                        ...
                                        show sayo casual glass smile2 at Three2 with Dissolve(0.2)
                ...
                "Move" if areas > 1:
                    menu:
                        "Office" if parse_bin(areas,1):
                            stop music fadeout 1.0
                            play music bg_toughchoices loop
                            scene bg policedepartment office with fade
                            $ current_area = 1
            ...
            if not parse_bin(visited,1):
                ...
                show emmerich smile at Three3 with Dissolve(0.2)
                ...
                show sayo casual glass serious at Three2 with Dissolve(0.2)
                show emmerich normaltalk at Three3 with Dissolve(0.2)
                p_emm "They wished to know more about the ongoing investigation, Sarge, as well as details about MH-0809."
                show sumiko casual seriousleft at Three1 with Dissolve(0.2)
                ...
                show sumiko casual serioustalk at Three1 with Dissolve(0.2)
                st3 "We understand.{w=1.0} Do we sign a Non-Disclosure Agreement?"
                ...
                p_dei "If,{w=0.5} however,{w=0.5} you can establish a connection between MSCI and SHA's murder cases, then I can grant you {i}temporary privileges{/i} effective only today."
                mh8 "That would do, Sarge. Thank you."
                show sumiko casual serious at Three1 with Dissolve(0.2)
                ...
                hide sumiko with Dissolve(0.2)
                show hikaru casual thinking at Three1 with Dissolve(0.2)
                hy10 "This is your first case, Inspector? That's a pretty big leap from your previous one."
                show emmerich smileteeth at Three3 with Dissolve(0.2)
                ...
                show hikaru casual surprised at Three1 with Dissolve(0.2)
                hy10 "Who is this other person?"
                show emmerich smile at Three3 with Dissolve(0.2)
                p_emm "Someone the same age as you. Calls herself \"Little Miss Detective.\""
                show hikaru casual surprisedtalk at Three1 with Dissolve(0.2)
                hy10 "This isn't a de-aged woman? You mean a child or a teenager helped you out? Must be a prodigy!"
                show emmerich determinedclosed at Three3 with Dissolve(0.2)
                p_emm "She's a nuisance.{w=1.0} {i}Was{/i} a nuisance, after all that she's done.{w=1.5} Can't really blame her for helping out with the case, especially if your best friend is involved."
                show emmerich determined at Three3 with Dissolve(0.2)
                p_emm "But enough sob stories. You'll know more about it one of these days.{w=2.0} What do you need?"
            ...
            if i2b_office == 7 and not parse_bin(areas,2):
                ...
                show sayo casual glass seriousleft at Three1 with Dissolve(0.2)
                ...
                show sayo casual glass normaltalk at Three1 with Dissolve(0.2)
                ...
                show sayo casual glass normaltalkleft at Three2 with Dissolve(0.2)
                sr5 "There is one more thing you might have overlooked.{w=1.0} The series of crimes took place in a span of ten months -- one victim each on the latter half of the month."
                show hikaru casual serioustalk at Three3 with Dissolve(0.2)
                ...
                show sumiko casual serioustalk at Three1 with Dissolve(0.2)
                play sound sfx_beep2
                show portrait kyou at PortraitL with Dissolve(0.1)
                st3 "Kyou Kirisaki was killed sometime between the 16th and the 25th;{w=1.0}{nw}"
                play sound sfx_beep2
                show portrait hiroshi at PortraitL with Dissolve(0.1)
                st3 "Kyou Kirisaki was killed sometime between the 16th and the 25th;{fast} Hiroshi Kano on the 19th.{w=1.0} Both dates fall within the letter's given range."
                play sound sfx_beep2
                hide portrait with Dissolve(0.1)
                ...
                p_emm "I agree, sir. These four give off an unusual aura.{w=1.0} Combined, they could match {i}her{/i} influence and competence."
                ...
                show sayo casual glass smiletalk at Three1 with Dissolve(0.2)
                            ...
                            while lock == 1 and not (parse_bin(i2b_archives,2)):
                                menu:
                                    "Purpose of visit":
                                        ...
                                        show sayo casual glass serious at Three1 with Dissolve(0.2)
                                        sr5 "I figured."
                                        show sumiko casual surprised at Three3 with Dissolve(0.2)
                                        ...
                                        show hikaru casual serioustalkleft at Three3 with Dissolve(0.2)
                                    ...
                                    "Hiroshi's case":
                                        ...
                                        p_emm "{cps=20}That's right. No exclusions...{/cps}"
                                        show hikaru casual angry2 at Three1 with Dissolve(0.2)
                                        hy10 "Hey! I was nowhere near the campus during that time."
                                        show emmerich smirk2 at Three2 with Dissolve(0.2)
                                        p_emm "I'm kidding!"
                                        show emmerich normaltalk at Three2 with Dissolve(0.2)
                                        ...
                                        p_emm "Correct.{w=1.0} What they {i}was{/i} used is this."
                                        ...
                                        p_emm "The suspect was using a glove. That had been disposed of as well."
                                        mh8 "Hmmmmm..."
                                        show emmerich serious at Three3 with Dissolve(0.2)
                                        p_emm "Can you think of anyone with a motive?"
                                        show sayo casual glass sleepytalk at Three1 with Dissolve(0.2)
                                        sr5 "Even if I had the perfect chance, I don't...{w=1.0} which is not an admission of guilt, mind you."
                                    ...
                                    "Cursed killings?":
                                        ...
                                        show emmerich smileteeth at Three2 with Dissolve(0.2)
                                        p_emm "That's good to hear!{w=1.0}{nw}"
                                        show emmerich normal at Three2 with Dissolve(0.2)
                                        p_emm "That's good to hear!{fast} The latter I'm not so sure about..."
            ...
            if not parse_bin(visited,2):
                ...
                show sayo casual glass seriousleft at Three3 with Dissolve(0.2)
                p_dei "Tell me somethin'.{w=0.5} What are you hoping to take away from this?"
                show sayo casual glass normaltalk at Three3 with Dissolve(0.2)
                ...
                show sayo casual glass smile at Three3 with Dissolve(0.2)
                "He scribbled on his notepad and tore off the page, handing it over to Sayo."
                play sound sfx_radiostatic
                "{i}*BUZZ* *BUZZ*{/i}"

                show sayo casual glass normaltalkleft at Three3 with Dissolve(0.2)
            ...
            menu:
                                ...
                                menu:
                                    "Fuuko Rikiyama":
                                        if not parse_bin(i2b_archives,0):
                                            scene bg ringbinder with dissolve
                                            play sound sfx_pageturn
                                            window show
                                            nvl clear
                                            ...
                                            call ch03_07B1_rikiyama from _call_ch03_07B1_rikiyama
                                            ...
                                            show sayo casual glass serious at Three2 with Dissolve(0.2)
                                            show sumiko casual serious at Three1 with Dissolve(0.2)
                                            show hikaru casual worried talk at Three3 with Dissolve(0.2)
                                            "Stunned.{w=1.5} I stopped myself from saying any more."

                                            show sayo casual glass normaltalk at Three2 with Dissolve(0.2)
                                            sr5 "Most of the evidence supports your theory, Miyu.{w=2.0} However, there are a lot of contestable points we picked up."
                                            mh8 "I know. A few details I mentioned just clicked into the story as I went along."
                                            show hikaru casual thinking at Three3 with Dissolve(0.2)
                                            ...
                                            show hikaru casual serious at Three3 with Dissolve(0.2)
                                            hy10 "She didn't mention anything of the sort. You sure you aren't mixing up the details?"
                                            ...
                                            show hikaru casual blank at Three3 with Dissolve(0.2)
                                            hy10 "I don't have an answer. Don't know what Inoue has been up to outside of our casual meetings."
                                            show sumiko casual serioustalk at Three1 with Dissolve(0.2)
                                    ...
                                    "Rika Suzumiya" if (parse_bin(i2b_archives,0) and parse_bin(bonus_b1_g,1)):
                                        if not parse_bin(i2b_archives,1):
                                            ...
                                            show sayo casual glass normaltalkleft at Three1 with Dissolve(0.2)
                                            sr5 "Hang on. Let me get the second volume."

                                            play music bg_undaunted loop
                                            scene bg ringbinder with dissolve
                                            play sound sfx_pageturn
                                            "The second volume of MH-0809 is thicker by a few pages. This one contains reports about the sixth to tenth victims."
                                            ...
                                            sr5 "Although, she isn't a swimmer. I wouldn't put it past her if she was flailing around struggling for air in that pool."
                                            mh8 "I see..."

                                            scene bg policedepartment archives with dissolve
                                            show sayo casual glass serious at Three1 with Dissolve(0.2)
                                            ...
                                            show sayo casual normaltalk at Three2 with Dissolve(0.2)
                                            sr5 "Mi-kun, where are you going?"
                                            mh8 "Something else has crossed my mind.{w=0.5} I --"
                                            show hikaru casual worried at Three1 with Dissolve(0.2)
                                            hy10 "We don't have much time. I'll be running late for our Congregation."
                                            show sayo casual serioustalk at Three2 with Dissolve(0.2)
                                ...
                                menu:
                                    "Contact Sarge":
                                        if not (parse_bin(i2b_archives,0) or parse_bin(i2b_archives,5)):
                                            ...
                                            "The Sergeant voiced his approval when he learned that Sayo returned the book to its designated place, stating that he hoped his fellow officers would do the same."
                                            ...
                                            show emmerich normal at Three3 with Dissolve(0.2)
                                            p_dei "Hey, Harold. Your four stooges are here."
                                            show hikaru casual silly at Three1 with Dissolve(0.2)
                                            hy10 "Nyuk!{w=0.25} Nyuk!{w=0.25} Nyuk!"
                                            show emmerich smileteeth at Three3
                                            ...
                                            show emmerich focusedleft at Three3 with Dissolve(0.2)
                                            ...
                                            if parse_bin(bonus_b1_g,2):
                                                ...
                                                show sayo casual glass normaltalkleft at Three1 with Dissolve(0.2)
                                                play sound sfx_beep2
                                                show portrait inoue at PortraitL with Dissolve(0.1)
                                                ...
                                                show emmerich worriedclosed at Three3 with Dissolve(0.2)
                                                p_emm "She did not bring anything out, however. Shame, but a thoughtful effort, nonetheless."
                                                hide hikaru with Dissolve(0.2)
                                                show sumiko casual serioustalkleft at Three1 with Dissolve(0.2)
                                                st3 "This might sound random, but were there any traces of liquid chlorine or {i}FDX-A{/i} inside Hiroshi's body?"
                                                show emmerich normal at Three3 with Dissolve(0.2)
                ...
                "Talk" if parse_bin(i2b_archives,0):
                    menu:
                        "Sumiko Tokubei":
                            show sumiko casual seriousleft at Three2 with Dissolve(0.2)
                            $ lock = 1
                            ...
                            while lock == 1 and not (parse_bin(i2b_archives,2)):
                                menu:
                                    "Ichirou's decision":
                                        ...
                                        show sumiko casual serioustalkleft at Three2 with Dissolve(0.2)
                                        st3 "Did he make the right decision?{w=0.5} Did {i}I{/i} make the right decision?{w=1.0} Given how everything has played out...{w=2.0}{nw}"
                                        show sumiko casual angry at Three2 with Dissolve(0.2)
                                        ...
                                        show sumiko casual smile at Three2 with Dissolve(0.2)
                                        ...
                                        show sumiko casual surprisedtalk at Three2 with Dissolve(0.2)
                                        st3 "Not to cast distrust on our batchmates,{w=0.5} but in a group of two-hundred, there is {i}always{/i} that one snitch who will inevitably blow the whistle."
                                        show sumiko casual surprised at Three2 with Dissolve(0.2)
                                        st3 "If that happens, then all eyes are on us.{w=1.0} About that, I'll say nothing further."
                                    ...
                                    "Liquid chlorine" if parse_bin(bonus_b1_g,2):
                                        ...
                                        show sumiko casual serious at Three2 with Dissolve(0.2)
                                        st3 "Not necessarily {i}harmless{/i}, but what you suggest is indeed questionable."
                                        ...
                                        show sumiko casual surprised2 at Three2 with Dissolve(0.2)
                                        st3 "I forgot the specifics. Let's ask the Inspector later."
                                        mh8 "I thought this is your area of expertise?"
                                        show sumiko casual surprisedtalk at Three2 with Dissolve(0.2)
                                        st3 "It's a bit complicated to recall the tiniest details about chlorine, especially if we are finding a toxic component within that specific element."
                                        mh8 "Fair enough."
                                    ...
                                    "Live wires":
                                        ...
                                        show sumiko casual seriousleft at Three2 with Dissolve(0.2)
                                        st3 "Wires are too thin to support a human body. Body weight is more than enough to break them.{w=1.0} You would need several rolls of {i}thick wire{/i} to counteract the force."
                                        mh8 "Which can be conveniently found inside that computer lab and, if they have one, the adjacent storage room."
                                        show sumiko casual serioustalk at Three2 with Dissolve(0.2)
                                        st3 "Even then, handling them that way poses a dangerous risk to both the victim and the attacker.{w=1.0} There would have been two corpses instead of one if the order was switched."
                        ...
                        "Hikaru Yamamoto":
                            show hikaru casual smile at Three2 with Dissolve(0.2)
                            $ lock = 1

                            while lock == 1 and not (parse_bin(i2b_archives,2)):
                                menu:
                                    "Inoue's condition":
                                        show hikaru casual worriedtalk at Three2 with Dissolve(0.2)
                                        hy10 "Mi-kun, did you really mean what you said earlier?"
                                        mh8 "About what?"
                                        show hikaru casual worried at Three2 with Dissolve(0.2)
                                        play sound sfx_beep2
                                        show portrait inoue at PortraitR with Dissolve(0.1)
                                        ...
                                        show hikaru casual serioustalk at Three2 with Dissolve(0.2)
                                        hy10 "You must keep in mind what she had been through.{w=1.0} Give her time and maybe she'll have a clearer outline of events."
                                        mh8 "How long?{w=0.5} When she finally dies?"
                                        show hikaru casual angry2 at Three2 with Dissolve(0.2)
                                        ...
                                        play sound sfx_beep2
                                        hide portrait with Dissolve(0.1)
                                        show hikaru casual serioustalkleft at Three2 with Dissolve(0.2)
                                        hy10 "Maybe Sayo-chan really did kill Kirisaki -- and possibly, Hiroshi?"
                                        mh8 "Not you too, Hikaru?"
                                        show hikaru casual serious at Three2 with Dissolve(0.2)
                                        hy10 "If that upsets you, why don't you stop asking the wrong questions?{w=1.0} You act as if you can make sensible decisions most of the time. Live up to that, if you please."

                                        if not parse_bin(i2b_archives,6):
                                            $ i2b_archives += 64

                                    "Nursery rhymes":
                                        show hikaru casual blank at Three2 with Dissolve(0.2)
                                        mh8 "{cps=15}Hmmmmmm...{/cps}"
                                        mh8 "Hey, Hikaru.{w=0.5} Do you have any favorite nursery rhyme?"

                                        stop music fadeout 1.0
                                        show hikaru casual thinkingleft at Three2 with Dissolve(0.2)
                                        ...
                                        show hikaru casual naughty at Three2 with Dissolve(0.2)
                                        ...
                                        mh8 "..."
                                        hy10 "..."
                                        show hikaru casual thinking at Three2 with Dissolve(0.2)
                                        hy10 "Why'd you ask?"
                                        mh8 "Nothing."

                                        play music bg_mindbender loop
                                        show hikaru casual blush at Three2 with Dissolve(0.2)
    ...
    show emmerich determined at Three3 with Dissolve(0.2)
    play sound sfx_beep2
    show portrait erika silhouette at PortraitR with Dissolve(0.1)
    ...
    show sayo casual glass smileclosed at Three1 with Dissolve(0.2)
    "She grinned and nodded silently."

    mh8 "Which means?"
    show sumiko casual sighclosed at Three1 with Dissolve(0.2)
    ...
    show hikaru casual thinkingleft at Three1 with Dissolve(0.2)
    ...
    show hikaru casual happy at Three2 with Dissolve(0.2)
...
label ch03_07B1_rikiyama:
    ...
    centered "{i}{b}*SLAM*{fast}{w=1.0}{/b}{/i}{nw}"
    play sound sfx_whispers loop
    centered "{i}{b}*rattle rattle*{/b}{/i}{w=2.0}\n\n{cps=15}{i}murmur... murmur... murmur...{/i}{/cps}"
    ...
    play sound sfx_dooropen
    narr "The door opened.{w=1.0}{nw}"
    play sound sfx_footsteps2
    narr "Stilletto steps on tiles passing by her stall.{w=1.5}{nw}"
    play sound sfx_doorclose
    narr "The other door closed.{w=1.0} Locked."
    ...
    narr "{b}*CRASH*{/b}{w=2.0}{nw}"
    play sound sfx_spark
    narr "{i}*fizzle* *spark* *spark*{/i}"
    stop sound fadeout 3.0
...
label ch03_08_facts5:
    if path_b1 < 0:
        call ch03_08A_guilty from _call_ch03_08A_guilty
    elif path_b1 >= 0:
        call ch03_08B_innocent from _call_ch03_08B_innocent
    return
...
label ch03_08A_guilty:
    ...
    stop music fadeout 1.0
    show ichirou surprised at Three3 with Dissolve(0.2)
    iy1 "Do you still remember what we talked about in the library?{w=1.0} You asked me a question about Inoue's credibility. I thought over it during the Sunday Mass."
    play music bg_onthingstocome loop
    ...
    ai2 "..."
    show ichirou surprised at Three3 with Dissolve(0.2)
    iy1 "Ahem.{w=0.5} ...Because she gatecrashed our peaceful interview...{w=1.0} right at an inopportune moment!{w=1.0} Had she arrived any earlier, Inoue's statements would have sounded more jumbled up."
    show akira surprised at Three1 with Dissolve(0.2)
    ...
    if parse_bin(bonus_b1_i,1):
        ...
        hide portrait with Dissolve(0.1)
        show akira bored at Three1 with Dissolve(0.2)
        ai2 "She's not my pick, though. How about you, Ichi?{w=1.0} Other than the three of us, who do you got as L.C.?"
        show ichirou focusleft at Three3 with Dissolve(0.2)
        iy1 "{cps=20}It would be...{w=1.5} Hmmmmmmmmm...{/cps}{w=3.0}{nw}"
        play sound sfx_beep2
        show portrait sayo at PortraitL with Dissolve(0.1)
        show ichirou serioustalk at Three3 with Dissolve(0.2)
        ...
        show ichirou surprised at Three3 with Dissolve(0.2)
        play sound sfx_beep2
        show portrait hikaru at PortraitL with Dissolve(0.1)
...
label ch03_08B_innocent:
    ...
    t_uen "Right you are!{w=1.0} Let's discuss how derivatives work, shall we?"

    stop music fadeout 1.0
    "That one moment was a temporary reprieve."
    "The class ended, and everything returned to how it was -- one seatwork after another."
    ...
    "Time-stamped 1:25 PM. It contained a set of photocopied reports like the ones they examined last Sunday."
    ...
    sr5 "In due time, Hikaru. We don't have time to have a prolonged discussion.{w=1.0} I'd say we keep them at bay until we have examined the documents thoroughly."
    hide sayo with Dissolve(0.2)
    hide hikaru with Dissolve(0.2)
    ...
    centered "{cps=20}The pink book states that blades and other deadly weapons are prohibited inside the school.{w=1.0} Cutters and scissors can only be brought if required by the teacher.{w=0.5} Therefore, all knives are out of the question.{w=3.0}\n\nHowever, consider the crime scene.{w=1.0} There are plenty of supplies inside the Student Council office, some of which may be potential instruments to the crime. Yet, no weapon was found.{w=2.0}\n\nIf so,{w=0.5} then maybe...{/cps}"
...
label ch03_09_ministryvisit:
    ...
    "She is not stopping.{w=1.0} Her mouth keeps on grinding out words.{w=1.0} The noise from the lower batches was worsening."

    unk "Shut the hell up already, you wretch..."
    minister "Isn't that right,{w=1.0} {cps=20}Mrs. Genkai and Mrs. Ritsuko?{/cps}{w=2.0} You kept Hiroshi Kano's death in the Student Council office a secret?"
    play music bg_controlledchaos loop
    play sound sfx_crowdtalking2 loop
    ...
    play sound sfx_crowdtalking3 loop
...
label ch03_10_facts6:
    if path_b1 < 0:
        call ch03_10A_guilty from _call_ch03_10A_guilty
    elif path_b1 >= 0:
        call ch03_10B_innocent from _call_ch03_10B_innocent
    return
...
label ch03_10A_guilty:
    ...
    f_iy1 "Why?{w=1.0} You want to say sorry?{w=0.5} You're going to persuade me to change my mind?{w=1.0} Forget it, buddy. Good night."
    show miyu pissed at Three2 with Dissolve(0.2)
    ...
    centered "{cps=25}{i}Unbelievable.{w=0.5} This is real.{w=1.0} I am hearing myself spout out these unjustified thoughts.{w=1.0} It is all hatred.{w=2.0}\nWhen was the last time I heard a \"good job\" from anyone?{w=1.0} Very recently, I'm sure.{/i}{/cps}"
    ...
    if parse_bin(bonus_b1_i,2):
        ...
        scene bg livingroom2 with dissolve
        show miyu bored at Three2 with Dissolve(0.2)
        f_iy1 "The volume was not higher than a loud whisper. You can still hear the crickets sing.{w=1.0} \"Condolence,\" they said."
        show miyu pissedclosedpose at Three2 with Dissolve(0.2)
        f_mh8 "Can you describe them for me? I only saw their back."

        centered "{cps=25}{i}What's the point of describing a silhouette?! I couldn't even distinguish anything aside from the road under the faint moonlight.{/i}{/cps}"
        ...
        "I got ourselves two glasses and a liter of Coke.{w} He looked at me strangely.{w} Heck, I'll have myself a glass of soda even if I have a cold. It helps me to think."
        ...
        scene bg school outside dark with dissolve
        centered "{cps=25}{i}Was he alluding to this idea?{w=1.0} My doubts about her before Sayo came along were true?{w=2.0}\nIf so, then that explains her ill temper and her superhuman strength when she knocked Miyu and Sumiko aside after she snapped.{/i}{/cps}{w=4.0}{nw}"

        scene bg underwater with dissolve
        centered "{cps=25}{i}What if Inoue drowned in that pool?{w=1.0} What if the Inoue we're seeing now is nothing more than a clone?{w=1.0} Its sentience is being controlled.{w=1.0} But is that...{/i}{/cps}{w=3.0}{nw}"

        scene bg livingroom2 with dissolve
        show miyu pissedleftpose at Three2 with Dissolve(0.2)
        f_iy1 "Is that a fact? Why aren't we seeing copies of Hiroshi and Kyou if indeed Copy-Inoue is dwelling among us?"
        show miyu pissedpose at Three2 with Dissolve(0.2)
        ...
        play music bg_echoesoftime loop
        show miyu pissedclosedpose at Three2 with Dissolve(0.2)
...
label ch03_10B_innocent:
    ...
    play sound sfx_beep2
    show portrait hiroshi at PortraitR with Dissolve(0.1)
    ...
    play sound sfx_beep2
    show portrait kyou at PortraitR with Dissolve(0.1)
    ...
    show hikaru seriousleft at Three1 with Dissolve(0.2)
    "So I have heard, but did not bother too much."
    ...
    f_sr5 "Sumiko, you told us Akira reached out to you regarding their own investigation. You do realize what that means, yes? I'm sure he will listen if you reason out properly.{w=1.0} Yoshiro, especially so."
...
label ch03_11_ceasefire:
    ...
    show inoue seriouspose at Three3 with Dissolve(0.5)
    narr "Inoue refused her classmates' invitation to eat at the canteen, settling down on the biscuits she bought earlier.{w} Her mind wandered, first reading the posters on the sides of the board before stopping to read {i}The Mark of Athena{/i}. She held the paper bookmark with her right thumb."
    ...
    show sayo seriousserious at Three1 with Dissolve(0.2)
    show inoue seriousclosedpose at Three3 with Dissolve(0.2)
    narr "At the doorway, she stood and stared into Inoue's eyes.{w} Inoue averted her sight."
    ...
    show sayo blankface at Three1 with Dissolve(0.2)
    show inoue seriousclosed at Three2 with Dissolve(0.2)
    "Inoue rose from her seat and approached Sayo."

    show inoue serioustalkclosed at Three2 with Dissolve(0.2)
    f_is4 "We've already made up. Why waste your time coming here?"
    show sayo serioustalk2 at Three1 with Dissolve(0.2)
    f_sr5 "Because I have to.{w=1.5} I'm going to waste my own time so I can talk to you.{w=1.0} I'm going to waste my time so I can see everyone together.{w=1.0} Most of all,{w=0.5} I'm going to waste my time so we can reach the end of this!"
    show sayo serioustalkleft at Three1 with Dissolve(0.2)
    f_sr5 "If you have no qualms, then come with me."
    show inoue serioustalk at Three2 with Dissolve(0.2)
    f_is4 "Where?"
    show sayo seriousclosed at Three1 with Dissolve(0.2)
    ...
    scene bg msci with dissolve
    "Inoue watched Sayo cross the small street, the latter uncaring if Inoue followed or not."
    "But as Sayo turned to check at the small stairs, Inoue was already closing the distance."
    ...
    show inoue serioustalk2 at Three2 with Dissolve(0.2)
    ...
    show sayo blankface at Three1 with Dissolve(0.1)
    show yoshiro worriedleft at Three3 with Dissolve(0.1)
    show inoue seriouspose at Three2 with Dissolve(0.2)
    "Inoue looked at the others befuddled.{w} She entwined her fingers under her chin, observing how the conversation will flow."
    ...
    show sayo smiletalk at Three1 with Dissolve(0.2)
    show inoue seriousclosedpose at Three3 with Dissolve(0.2)
    f_sr5 "First of all, I want to thank everyone for your time.{w=2.0} The last time we gathered, things went turbulent. I hope the outdoors would enable us to decide with a more positive mindset."
    show sayo normaltalkleft at Three1 with Dissolve(0.2)
    ...
    show sayo normaltalk at Three1 with Dissolve(0.2)
    f_sr5 "Therefore, we propose that we end this pointless feud and combine our efforts to prevent L.C. from taking another life; at the same time, to inch closer to exposing their true identity."
    show sayo seriousnormal at Three1 with Dissolve(0.2)
    show inoue serioustalk at Three3 with Dissolve(0.2)
    ...
    show sayo smileclosed at Three1 with Dissolve(0.2)
    f_sr5 "What is there to prove if the evidence never existed in the first place?"
    show inoue seriousclosed at Three3 with Dissolve(0.2)
    f_is4 "Hmph."
    show sayo smileopen at Three1 with Dissolve(0.2)
    ...
    scene bg school fields dark with dissolve
    show yoshiro serious at Three3 with Dissolve(0.2)
    ...
    play music bg_calmertimes loop
    scene bg school fields with dissolve
    show sumiko surprised2 at Three1 with Dissolve(0.2)
    show yoshiro serious2 at Three3 with Dissolve(0.2)
    f_ys6 "Let me remind everyone that we all maintain divisive beliefs regarding the main culprit's identity.{w=1.0} Since the police is of little help, we searched for evidence to prove our own claims."
    show sumiko smile at Three1 with Dissolve(0.2)
    f_st3 "Yet we cannot discredit their efforts.{w=1.0} It is because of them we have access to the details of the crime."
    show yoshiro smile at Three3 with Dissolve(0.2)
    ...
    show akira boredtalk at Three2 with Dissolve(0.2)
    f_ai2 "Is this referring to us or the info related to the case?"
    show akira bored at Three2 with Dissolve(0.2)
    show yoshiro talkleft at Three3 with Dissolve(0.2)
    ...
    f_ys6 "Precisely.{w=1.0} It's the same problem we've been trying to piece together but couldn't figure out how.{w=1.0} If, by any chance, it can make the process easier, then we're open to lower the barrier."
    hide akira with Dissolve(0.2)
    stop music fadeout 1.0
    show inoue serioustalk2 at Three2 with Dissolve(0.2)
    play sound sfx_fistbang
    ...
    show akira proud2 at Three3 with Dissolve(0.2)
    f_ai2 "Alright, Pres.{w=1.0} My decision...{w=1.0} Ummmmm..."
    show sumiko smirk at Three1 with Dissolve(0.2)
    ...
    hide akira
    play sound sfx_smack
    show hikaru angryclosed2 at Three1 with vpunch
    f_hy10 "Shut up!"

    show hikaru serious2 at Three1 with Dissolve(0.2)
    show inoue serious at Three3 with Dissolve(0.2)
    "Silence."
    ...
    show yoshiro surprised at Three3 with Dissolve(0.2)
    ...
    show yoshiro smile at Three3 with Dissolve(0.2)
    f_ys6 "And Hikaru for the nursery rhymes. In fact, maybe Aria can help us out with that, too."
    hide sumiko with Dissolve(0.2)
    hide yoshiro with Dissolve(0.2)
    show hikaru smile at Three1 with Dissolve(0.2)
    play sound sfx_beep2
    show portrait aria at PortraitL with Dissolve(0.1)
    ...
    show akira smileleft at Three2 with Dissolve(0.2)
    f_ai2 "Oh, we do!"
    hide sumiko with Dissolve(0.2)
    show sayo seriousnormalpose at Three1 with Dissolve(0.2)
    f_sr5 "..."
    ...
    scene bg school fields
    stop sound
    show inoue serioustalkclosedpose at Three2
    c_is4 "Pass."
    hide inoue with Dissolve(0.5)
    show sumiko surprised2 at Three2 with Dissolve(0.2)
    ...
    show sumiko sighclosed at Three2 with Dissolve(0.2)
    ...
    stop music
    show hikaru surprised at Three1
    show sumiko surprised2 at Three2
    show sayo seriousnormalpose at Three3
    c_is4 "If I may!"
    hide sayo with Dissolve(0.2)
    hide sumiko with Dissolve(0.2)
    hide hikaru with Dissolve(0.2)

    show inoue smilepose at Three2 with Dissolve(1.0)
    "Finally.{w=1.0} The oddball has spoken up."

    show inoue talk at Three2 with Dissolve(0.2)
    c_is4 "I have considered all your opinions carefully. In fact, that gives me enough room to justify my decision.{w=2.0} You would forgive me if I do not share the same sentiments as all of you."
    ...
    c_is4 "Hikaru said it best. We all want to seek the truth, and all claims must be accompanied with a solid proof.{w=1.0} If you are so interested in our findings, Sayo, I suggest you start with mine."
    show sayo seriousserious at Three1 with Dissolve(0.2)
    f_sr5 "Alright.{w=0.5} Bring it out."
    show inoue happyopen at Three3 with Dissolve(0.2)
    c_is4 "I hope you'll all understand why I cannot agree to this readily."
    ...
    "There was a streak of red on one of the edges.{w} When she noticed it, the others followed and became unsettled."
    ...
    if path_b1 < 0:
        $ persistent.guilty = True
        scene bg splash august guilty with fade
        scene bg splash august guilty with Pause(10.0)
    elif path_b1 >= 0:
        $ persistent.innocent = True
        scene bg splash august innocent with fade
        scene bg splash august innocent with Pause(10.0)
...
label ch03_12_death03:
    ...
    centered "{color=#808080}{i}{cps=15}It is useless to deny it.{w=2.0} You cannot escape...{/cps}{/i}{/color}"
    ...
    centered "{color=#808080}{i}{cps=20}Among a hundred sheep, one has led itself astray.{w=2.0}\nSome may wonder,{w=1.0} does the shepherd bother to look for it while leaving the others?{w=1.5} The answer is, \"Yes! He does!\"{/cps}{/i}{/color}{w=4.0}{nw}"
    centered "{color=#808080}{i}{cps=20}Although,{w=1.0} it seems that{w=3.0}{/cps}{/color} {color=#bd0000}the master did not make it after all...{/color}{/i}"
    ...
    play sound sfx_razor2
    scene bg bedroom2 nightmare with vpunch
    "{b}{i}*BUZZ*{/i}{/b}"
    stop sound
    ...
    "{i}You bastard!{w=1.0} You...{w=1.0} You tricked me.{w=0.5} Cheater!{w=0.5} Murderer!{w=0.5} What have you done to me?{w=1.0} Why are you doing this?{/i}"
    unk "Questions{w=0.5} upon questions{w=0.5} upon questions...{w=1.5} It only becomes more complicated the longer this entire farce drags on.{w=0.5} And for good reason.{w=1.5} Plucking out sheep like you is cathartic.{w=0.5} You are no different than those who treat their words as gospel."
    ...
    "And one of them hopped towards me.{w=2.0}{nw}"
    stop music
    show sayo creepy smile at Three2 with Dissolve(0.2)
    "And one of them hopped towards me.{fast} She leaned forward, making herself known."

    show sayo creepy smileteeth at Three2 with Dissolve(0.5)
    u_sr5 "Hello."
    ...
    show miyu noglass smileclosed at Eight6 with Dissolve(1.0)
    show miyu noglass smirkclosed at Eight6 with Dissolve(0.5)
    "He joined her, curving his lips to a similar Cheshire Cat-like grin as hers."

    show miyu creepy smileteeth at Eight6 with Dissolve(0.2)
    u_mh8 "Did I promise not to say that?{w=1.0} {i}*snicker* *snicker*{/i} Sorry..."

    show miyu creepy smirk at Eight6 with Dissolve(0.2)
    ...
    u_is4 "I'm not sure. Sometimes, it would be the {i}same voice as in the CD recording{/i}. Other times, it would warp to a {i}female{/i}. It was witch-like, the second one!"

    "{cps=20}The only way {i}that{/i} would make sense is if...{/cps}{w=3.0}{nw}"
    ...
    show miyu creepy smirk at Eight6 with Dissolve(0.2)
    u_mh8 "In short...{w=1.0} Game over.{w=1.5} Tsk. {i}*giggle* *giggle*{/i}{w=2.0} Look at him. Moping like he lost badly in a game of tag,{w=1.0} or he got red-flagged and banned from playing volleyball!{w=1.0} Oooooh... The horror!"
    ...
    show miyu creepy blankleft at Eight6 with Dissolve(0.2)
    show sayo creepy worriedtalkpose at Three2 with Dissolve(0.5)
    u_mh8 "He's sad.{w=1.0} Why don't we sing a song?"
    show sayo creepy seriouspose at Three2 with Dissolve(0.5)
    u_sr5 "{cps=20}What will it be?{w=2.0}{/cps}{nw}"
    show sayo creepy smile at Three2 with Dissolve(0.2)
    u_sr5 "{cps=20}What will it be?{fast} Oh! {b}*clap*{/b} I know just the thing. Glad my memory is ever reliable.{/cps}"

    show miyu creepy blankleftpose at Eight6 with Dissolve(0.2)
    "She whispered something into his ear.{w} What that song is, like I care."
    stop music
    show miyu creepy happyleftpose at Eight6 with Dissolve(0.2)
    "{b}{i}*clap*{w=1.0} *clap*{w=1.0} *clap*{w=1.0} *clap*{/i}{/b}"

    show sayo creepy smiletalkpose at Three2 with Dissolve(0.2)
    show miyu creepy smiletalk at Eight6 with Dissolve(0.2)
    ...
    "{cps=15}{i}Two for the master, and one for the dame...{w=1.0}\n{color=#bd0000}None for the little boy who cried down the lane!{/color}{/i}{/cps}"
    r_iy1 "Kekekekekekeke...{w=1.0} Ahehehehehehehehehe...{w=1.0} GAHAHAHAHAHAHAHAHAHAHAHAHAHA!!!"
    show miyu creepy smile at Eight6 with Dissolve(0.2)
    show sayo creepy smirkpose2 at Three2 with Dissolve(0.2)
    ...
    "They scraped the skin off to form two numbers --{w=2.0} {color=#bd0000}1{/color} and {color=#bd0000}2{/color} on the left and right hands, respectively."

    scene bg bedroom2 nightmare with dissolve
    show sayo creepy blood smirk at Three2 with Dissolve(0.2)
    ...
    show sayo creepy blood worried at Three2 with Dissolve(0.5)
    u_sr5 "{cps=20}That's a shame.{/cps}"

    play sound sfx_splatter
    "{b}*SQUELCH*{/b}"

    show sayo creepy blood serious at Three2 with Dissolve(0.5)
    ...
    stop music
    play sound sfx_razor2
    scene bg blood2 with hpunch
    centered "{color=#000000}{b}{i}*GRIIIIIIIIIIIIIIIIIIIIIIIND*{/i}{/b}{/color}"

    scene bg bedroom2 night with vpunch
    window show
    nvl clear
